...
func TestSaveState_RoundTrip(t *testing.T) {
	...
	s := newState()
	s.lastVisitTS["example-backend"] = 1714000000
	...
	if got, want := s2.lastVisitTS["example-backend"], int64(1714000000); got != want {
		t.Errorf("lastVisitTS[example-backend] = %d, want %d", got, want)
	}
