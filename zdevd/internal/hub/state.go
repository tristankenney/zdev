...
func applyEvent(s *state, ev tmuxctl.Event, emit func(eventlog.Event)) {
	...
	case tmuxctl.DataRefresh:
		// Probes supply e.Project in slash-form ("zitcha/backend"); normalize
