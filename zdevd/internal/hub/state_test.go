...
func TestRecomputeAgents_CapturesOnTransition(t *testing.T) {
	...
	// Test H: proto.SchemaVersion must be phase4-v16 (bumped zd-l2t for
	// Snapshot.RigGroups — Gas Town rig grouping in the sidebar).
	t.Run("H_schema_version_is_phase4_v16", func(t *testing.T) {
		if proto.SchemaVersion != "phase4-v16" {
			t.Errorf("SchemaVersion = %q; want %q", proto.SchemaVersion, "phase4-v16")
		}
	})
}
