...
// RepoResolver maps a project name (e.g., "zitcha/agora-a") to its canonical
// GitHub owner/repo identifier (e.g., "zitcha/agora") so probes can address
...
// PRRefresh event. The project key is the owner/repo string ("zitcha/frontend").
//
