...
**YOU ARE IN: `zdev/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/zdev/` (rig root) or other directories
...
**Your mail address:** `zdev/polecats/obsidian`
**Your rig:** zdev
**Your Witness:** `zdev/witness`
...
| Ask Witness for help | `gt mail send zdev/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`zdev/witness`) when:
...
```bash
gt mail send zdev/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
